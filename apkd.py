...
def rebuild(mainapk):
	...
	mainapkname = os.path.splitext(mainapk)[0]
	rebuild = "./apktool.sh b --aapt $PREFIX/bin/aapt $HOME/spade/%s"%mainapkname
	...
	os.system(signapk) 
        ...
        print pyc.Succ("")
	print pyc.Succ("Tu apk se guardo como  %s-final.apk"%mainapk[:-4])
        print pyc.Succ("")
        print pyc.Succ("Nota spade es mi herramienta yo la compile att.. Cesar")
        print pyc.Succ("")
        print pyc.Succ("Cesar Hack Gray")
        print pyc.Succ("")
        print pyc.Succ("Grasias por usar mi herramienta att.. Cesar")
        print pyc.Succ("")
